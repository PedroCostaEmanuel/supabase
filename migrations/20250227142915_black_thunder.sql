/*
  # Add webhook notification for audio files

  1. Changes
    - Create function to send webhook notifications when audio files are created
    - Add trigger to automatically send notifications
    - Use new webhook URL for Make.com integration
